...
\setlist[itemize,1]{label=\textcolor{mycolor1}{\footnotesize$\boldsymbol{\sim}$}}
\setbeamersize{description width=.5cm}


% Define the command to draw the circled number
\newcommand*\mycirc[1]{%
  \begin{tikzpicture}[baseline=(C.base)]
    \node[draw, circle, inner sep=1pt, fill=mycolor1 ,minimum size=3ex](C) {#1};
  \end{tikzpicture}}
