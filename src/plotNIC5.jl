...
avgfilelist1 = Glob.glob("*.nc", joinpath(datadir, casename))
avgfilelist2 = Glob.glob("*.nc.1", joinpath(datadir, casename))
...
function plot_temp(lon::Matrix{Float64}, lat::Matrix{Float64}, T::Matrix{Float32}, thedate::DateTime, figname::AbstractString)
